...
<head>
  ...
  <link href="halaman_depan.css" rel="stylesheet">
</head>
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h1 class="h5 text-gray-900 mb-4">Aplikasi Pengaduan Masyarakat</h1>
                  </div>
                  ...
                  <div class="text-center">
                  Sudah Punya Akun?<br>
                    <a class="small text-info" href="login.php">Login!</a>
                  </div>
                </div>
              </div>
            </div>
