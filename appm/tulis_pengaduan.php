...
<div class="card shadow isian">
    <div class="card-header">
        Tulis Pengaduan
</div>
<div class="card-body">
    <form action="simpan_pengaduan.php" method="post" class="form-hotizontal" enctype="multipart/form-data">
    <div class="form-group cols-sm-6">
        <label>Tanggal Pegaduan</label>
    ...
    <div class="form-group cols-sm-6">
        ...
        <font color="red">*tipe yang bisa diupload jpg, .jpeg, .png, .gif </font>
    </div>
