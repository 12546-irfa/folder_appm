...
<nav class="navbar navbar-expand-lg navbar-light h5">
    ...
    <a class="navbar-brand text-light" href="petugas.php">APPM</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link text-light" href="?url=verifikasi_pengaduan">Verifikasi Pengaduan<span class="sr-only">(current)</span></a>
        </li>
  ...
  <div id="">
    ...
    <div id="content" class="d-flex flex-column">
      ...
      <div id="content">
           ...
           <h1 class="h4 text-white mb-1 text-center">Aplikasi Pelaporan Pengaduan Masyarakat</h1>
        <div>
        </nav>
        <!-- End of Topbar -->
